      ...
      <CommentModalProvider>
        <FeedProvider>
          <div className="home-page-container">
            ...
            {feedItems.length ? <FeedList items={feedItems} creatorsById={usersById} currentUserId={user?.id} /> : <div className="bubble-card rounded-[32px] p-6 text-sm text-text-secondary">No content has been posted yet.</div>}
          </div>
        </FeedProvider>
        <CommentModal />
      </CommentModalProvider>
